        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-3 rounded-2xl border-2 border-dashed border-gray-200 p-6 text-center">
              ...
              <div>
                <label className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-emerald-500 cursor-pointer">
                  <Upload size={18} />
                  Chọn ảnh
                  <input
                    type="file"
